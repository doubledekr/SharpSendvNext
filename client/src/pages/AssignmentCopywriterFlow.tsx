            ...
            {assignment?.referenceUrl && (
              <div className="mt-3 flex items-center gap-2">
                ...
                <a 
                  ...
                  className="text-sm text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 underline truncate max-w-lg"
                  title={assignment.referenceUrl}
                >
                  {assignment.referenceUrl}
                </a>
              </div>
